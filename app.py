...
# --- WORD GENERATOR (ASIL NUSXA BILAN BIR XIL) ---
def create_docx(d):
    doc = Document()
    ...
    def add_p(text, bold=False, align="justify", space_after=0):
        p = doc.add_paragraph()
    ...
    # 1-SAHIFA
    add_p("Махсулот қийматини бўлиб тўлаш шарти билан тузилган", True, "center")
    add_p(f"№ {d['nomer']}- сонли олди сотди", True, "center")
    add_p("ШАРТНОМА", True, "center")
    ...
    add_p("1.1. Ушбу Шартномага асосан “Сотувчи” товарларни “Харидор”нинг эгалигига топшириш, “Харидор” эса ушбу товарларни қабул қилиб олиш va улар учун белгиланган қийматни бўлиб тўлаш мажбуриятини ўз зиммаларига оладиlar.")
    ...
    add_p(f"4.1. Товарларга тўлов “Харидор” томонидан 2-иловада белгиланган жадвалга мувофиқ амалга оширилади. 4.4. Тўланган пул маблағлари, аввало, тўловларни ўз вақтида тўламаганлик учун жарима тўловига, сўнgra қарздорликни қоплашга йўналтирилади.")

    # 2-SAHIFA: BANDLAR 5-9
    doc.add_page_break()
    ...
    add_p("7.1. Тўлов графиги бузилса ёки Харидорнинг молиявий ҳолати ёмонлашса, Сотувчи қарзни муддатдан олдин тўлиқ қайтаришни талаб қилишга ҳақли.")
    ...
    add_p("8.1. Сотувчи: сиfatли товар етказиш. 8.2. Харидор: товарни кўриб қабул қилиш ва вақтиda тўлаш.")

    # 3-SAHIFA: 10-BAND (MAS'ULIYAT)
    doc.add_page_break()
    add_p("10. Тарафларнинг масъулияти", True, "center")
    add_p(f"10.5. Тўлов муддатлари ўтганидан сўнг, “Харидор”дан кечиктирилган ҳар бир кун учун тўланмаган суммадан 2,0 % миқдорида, бироқ 50% дан ошмаган ҳолда жарима ундирилади.")
    ...
    # 4-SAHIFA: BANDLAR 11-15
    doc.add_page_break()
    add_p("11. Товарларни топшириш шартлари", True, "center")
    add_p("11.2. Товар топширилаётганда унга Сотувчи томонидан Идентификатор ўрнатилади.")
    add_p("14. Низоларни хал қилиш", True, "center")
    add_p("14.1. Барча низолар музокара йўли билан ёки Сирдарё вилояти судларида ҳал қилинади.")
    add_p("15. Якуний қоидалар", True, "center")
    add_p("15.7. Шартнома 2 нусхада тузилди ва иккаласи ҳам тенг юридик кучга эга.")

    # 5-SAHIFA: 1-ILOVA (JADVAL)
    doc.add_page_break()
    add_p("1-илова\nТовар спецификацияси", True, "center")
    ...
    # 6-SAHIFA: 2-ILOVA (GRAFIK)
    doc.add_page_break()
    add_p("2-илова\nТўловлар жадвали", True, "center")
    ...
    doc.add_page_break()
    add_p("Қабул қилиш – топшириш далолатномаси", True, "center", size=14)
...
# --- INTERFEYS ---
st.header("📑 Rasmiy Shartnoma Generatori (7 Sahifa)")
with st.form("f"):
    ...
    with col1:
        ...
        p_sana = st.text_input("Pasport berilgan sana:", "23.02.2024")
    with col2:
        ...
        oylar = st.number_input("Muddat (oy):", 3, 24, 6)
